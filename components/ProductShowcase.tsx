      ...
      <div className="relative bg-slate-900 border border-slate-800 rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-900/50 backdrop-blur-sm">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm font-medium text-slate-400">Talent AI / Dashboard / Open Roles / DevOps-2024</span>
          </div>
        ...
        {/* Toolbar */}
        <div className="px-6 py-4 bg-slate-900 flex justify-between items-center gap-4">
            <div className="flex items-center gap-2 flex-1">
                <div className="relative flex-1 max-w-md">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" size={16} />
                    <input 
                        type="text" 
                        placeholder="Ask Talent AI to filter candidates..." 
            ...
            <div className="flex items-center gap-2">
                <button className="px-3 py-1.5 text-xs font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded-full">
                    AI Analysis Ready
                </button>
            </div>
        </div>
        ...
        {/* Table Header */}
        <div className="grid grid-cols-12 gap-4 px-6 py-3 bg-slate-800/30 text-xs font-semibold text-slate-500 uppercase tracking-wider border-y border-slate-800">
        ...
        <div className="divide-y divide-slate-800/50 bg-slate-900">
            {candidates.map((c, idx) => (
                <div key={idx} className="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-slate-800/30 transition-colors cursor-pointer group">
        ...
        <div className="px-6 py-3 bg-slate-900 border-t border-slate-800 flex justify-between items-center text-xs text-slate-500">
            <span>Showing 1-5 of 248 candidates</span>
            <div className="flex gap-2">
                <button className="hover:text-slate-300">Previous</button>
                <button className="hover:text-slate-300">Next</button>
            </div>
        </div>
      </div>
    </div>
